...
interface MermaidTemplatePreviewProps {
  diagramCode: string;
}

const MermaidTemplatePreview = memo(
  ({ diagramCode }: MermaidTemplatePreviewProps) => {
...
MermaidTemplatePreview.displayName = "MermaidTemplatePreview";
export default MermaidTemplatePreview;
